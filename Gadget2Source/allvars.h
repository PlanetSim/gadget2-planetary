...
extern struct global_data_all_processes
{
  ...
  // JMAA 8/2011 - Code globals relating to artificialcooling.c
  int ReduceVels;                              /*!< Flag denoting whether velocities will be artificially reduced every timestep */
  double RestitutionFac;                       /*!< Factor between 0 & 1 by which velocities will be artificially reduced */
  int ReduceEnt;                               /*!< Flag denoting whether to artificially reduce entropy (& thereby cool) every full timestep */
  double UTotIdeal;                            /*!< Ideal total internal energy (not per unit mass) in ergs */
  double UTollFac;                             /*!< Tollerance factor of how far we can be from UTotIdeal */
  double UReductionFac;                        /*!< Fraction of the difference in total internal energies to lose each timestep */
