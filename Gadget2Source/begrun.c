  ...
  if(ThisTask == 0)		/* read parameter file on process 0 */
    {
      ...
      // JMAA 8/2011 - The following six parameters added to turn on &
      // control behaviour of artificialcooling.c
      strcpy( tag[nt], "ReduceVels" );
      addr[nt] = &All.ReduceVels;
      id[nt++] = INT;

      strcpy( tag[nt], "RestitutionFac" );
      addr[nt] = &All.RestitutionFac;
      id[nt++] = DOUBLE;

      strcpy( tag[nt], "ReduceEnt" );
      addr[nt] = &All.ReduceEnt;
      id[nt++] = INT;

      strcpy( tag[nt], "UTotIdeal" );
      addr[nt] = &All.UTotIdeal;
      id[nt++] = DOUBLE;

      strcpy( tag[nt], "UTollFac" );
      addr[nt] = &All.UTollFac;
      id[nt++] = DOUBLE;

      strcpy( tag[nt], "UReductionFac" );
      addr[nt] = &All.UReductionFac;
      id[nt++] = DOUBLE;
