...
# apply to your run. Then select target machine below.
# If you modify any of these options, make sure that you recompile 
# the whole code by typing "make clean; make".      
#                                                                      
...
CC       =  /usr/local/mpich.gcc/bin/mpicxx
endif
...
OPTIMIZE =   -O2 -funroll-loops -mcmodel=medium
GSL_INCL =   
GSL_LIBS =   
FFTW_INCL=   
FFTW_LIBS=
...
ifeq ($(SYSTYPE),"bluecrystal")
CC       =  mpicc
OPTIMIZE =  -O3 -Wall -g
GSL_INCL = -I/cm/shared/libraries/gnu_builds/gsl-1.16/include
GSL_LIBS = -L/cm/shared/libraries/gnu_builds/gsl-1.16/lib -static -lgsl -lgslcblas
FFTW_INCL= -I/cm/shared/libraries/gnu_builds/fftw-2.1.5-mpi/include
FFTW_LIBS= -L/cm/shared/libraries/gnu_builds/fftw-2.1.5-mpi/lib -static -lrfftw_mpi -lfftw_mpi -lrfftw -lfftw
MPICHLIB = 
HDF5INCL = 
HDF5LIB  = -lhdf5
endif
...
ifeq ($(SYSTYPE),"BC4")
CC       =  mpicc
OPTIMIZE =  -Og -Wall -g  #-O3
GSL_INCL =  -I/mnt/storage/easybuild/software/GSL/2.3-foss-2017a/include
GSL_LIBS =  -L/mnt/storage/easybuild/software/GSL/2.3-foss-2017a/lib
FFTW_INCL= -I/mnt/storage/easybuild/software/FFTW/3.3.6-gompi-2017a/include
FFTW_LIBS= -L/mnt/storage/easybuild/software/FFTW/3.3.6-gompi-2017a/lib   -lfftw3_mpi
MPICHLIB = -L/mnt/storage/easybuild/software/OpenMPI/2.0.2-GCC-6.3.0-2.27/lib  -lmpi
HDF5INCL =  -I/opt/hdf5/include
HDF5LIB  =  -L/opt/hdf5/lib -static -lhdf5 -lz
endif
...
CC       =  mpicc
OPTIMIZE =  -O3 -Wall -g
GSL_INCL =  -I/mnt/storage/software/libraries/gnu/gsl-2.5/include
GSL_LIBS =  -L/mnt/storage/software/libraries/gnu/gsl-2.5/lib
FFTW_INCL= -I/mnt/storage/software/libraries/intel/fftw-3.3.6-mpi/include
FFTW_LIBS= -L/mnt/storage/software/libraries/intel/fftw-3.3.6-mpi/lib   -lfftw3_mpi -lfftw3
MPICHLIB = #-L/mnt/storage/easybuild/software/OpenMPI/2.0.2-GCC-6.3.0-2.27/lib  -lmpi
HDF5INCL =  -I/opt/hdf5/include
HDF5LIB  =  -L/opt/hdf5/lib -static -lhdf5 -lz
endif
...
OBJS   = main.o  run.o  predict.o begrun.o endrun.o global.o  \
	 ...
	 eos_table_interp.o artificialcooling.o

INCL   = allvars.h  proto.h  tags.h  Makefile eos.h
...
ifeq (NOTYPEPREFIX_FFTW,$(findstring NOTYPEPREFIX_FFTW,$(OPT)))    # fftw installed with type prefix?
  ifneq (,$(filter $(SYSTYPE),"BC4" "BC4i"))       #PJC 24/08/2021
