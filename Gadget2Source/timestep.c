      ...
      if(P[i].Ti_endstep == All.Ti_Current)
	{
	  ...
	  if(P[i].Type == 0)	/* SPH stuff */
	      ...
	      for(j = 0; j < 3; j++)
		{
	      ...
	      /* JMAA 8/2011 - RAM added this "if" statement to limit
	       * entropy increases to 10fold in 1 timestep */
		...
		fflush(stdout);
	      ...
	      /* JMAA 8/2011 - prevent this from happening if we're
	       * artificially cooling by reducing entropy */
	      if( All.ReduceEnt == 0 ) {
